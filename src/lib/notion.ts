...
const LOCAL_FORMATIONS: Formation[] = [
  {
    ...
    image: '/images/formations/automatisation-taches-repetitives-pme.jpg',
    online: false,
    price: undefined,
    fundingActive: true,
  },
  {
    ...
    image: '/images/formations/ia-productivite-quotidienne-pme.jpg',
    online: false,
    price: undefined,
    fundingActive: true,
  },
  {
    ...
    image: '/images/formations/securite-donnees-conformite-pme.jpg',
    online: false,
    price: undefined,
    fundingActive: true,
  },
...
const LOCAL_RESOURCES: Resource[] = [
  {
    ...
    published: true,
    photo: '/ressources/rgpd-pme-10-points-controle/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-identifier-cartographier-taches/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-connecteurs-n8n/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-relances-clients/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-saisie-export-donnees/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-notifications-alertes/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-securiser-maintenir-workflows/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-documenter-workflow/cover.jpg',
  },
  {
    ...
    published: true,
    photo: '/ressources/automatisation-cas-pratique-complet/cover.jpg',
  },
];
...
const LOCAL_CASE_STUDIES: CaseStudy[] = [
  {
    ...
    result: "Gain de 2 h 30 par semaine, amélioration de la qualité des suivis et réduction des oublis.",
...
function mapFormation(page: any): Formation {
  ...
  return {
    ...
    outcomes: getPropertyText(p["Résultats pédagogiques"]) || getPropertyText(p["Résultats pedagogiques"]),
    ...
    format: '',
    objectives: getPropertyText(p["Résultats pédagogiques"]) || getPropertyText(p["Résultats pedagogiques"]),
    prerequisites: '',
    image: '',
    online: false,
    price: getPrice(p),
...
function mapCaseStudy(page: any): CaseStudy {
  ...
  return {
    ...
    anonymized: getCheckbox(p.Anonymisé) || getCheckbox(p.Anonymise),
